...
set ylabel "(Pkts with RTT > 15ms) / (pkts/s)"
...
plot inFileDefDLB using 1:(mkval($32)):(mkval($32+$33)):(mkval($32-$33)) w yerrorlines title "SliM (1400)" linestyle 1, \
	inFileLgcyDLB using 1:(mkval($32)):(mkval($32+$33)):(mkval($32-$33)) w yerrorlines title "Duplication (1400)" linestyle 2, \
	inFileDefDL using 1:(mkval($32)):(mkval($32+$33)):(mkval($32-$33)) w yerrorlines title "SliM (512)" linestyle 3, \
	inFileLgcyDL using 1:(mkval($32)):(mkval($32+$33)):(mkval($32-$33)) w yerrorlines title "Duplication (512)" linestyle 4
